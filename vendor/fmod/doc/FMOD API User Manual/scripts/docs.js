...
function init() {
  // Setup language tabs
  languageTabs = document.getElementsByClassName("language-tab");
  ...
  languageSpecificElements = document.querySelectorAll(".language-c, .language-cpp, .language-c-cpp, .language-csharp, .language-javascript");
